...
$query = "INSERT INTO `User_Favorites`(`User_id`, `Flight_No`) VALUES ('".$_SESSION['user_id']."','".$flightno."')";

$result = mysqli_query($con,$query);

if($result)
{   
	$query2 = "SELECT * from flight_details f, user_favorites u where u.User_id = '".$_SESSION['user_id']."' and u.Flight_No = f.Flight_No";
